...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('font/img/favicon.ico')}}" rel="icon">
    ...
    <link href="{{asset('font/lib/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('font/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{asset('font/ss/bootstrap.min.css')}}c" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <img class="{{asset('font/img-fluid" src="img/logo.png')}}" alt="Logo">
                </a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="{{asset('font/w-100" src="img/carousel-2.jpg')}}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="{{asset('font/img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="img/about-1.jpg')}}" alt="">
                            <img class="{{asset('font/img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="img/about-3.jpg')}}" alt="">
                        </div>
                        <div class="col-6">
                            <img class="{{asset('font/img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="img/about-4.jpg')}}" alt="">
                            <img class="{{asset('font/img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="img/about-2.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-4">
                            <img class="{{asset('font/img-fluid bg-white w-100" src="img/about-5.jpg')}}" alt="">
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4">
                            <img class="{{asset('font/img-fluid bg-white w-100" src="img/about-6.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('font/img/product-1.jpg')}}" alt="">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('font/img/product-2.jpg')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('font/img/product-3.jpg')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{asset('font/img/product-4.jpg')}}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    <img class="{{asset('font/img-fluid" src="img/article.jpg')}}" alt="">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <img class="{{asset('font/img-fluid" src="img/store-product-1.jpg')}}" alt="">
                    <div class="p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="store-item position-relative text-center">
                        <img class="{{asset('font/img-fluid" src="img/store-product-2.jpg')}}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="store-item position-relative text-center">
                        <img class="{{asset('font/img-fluid" src="img/store-product-3.jpg')}}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                <div class="testimonial-item p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="{{asset('font/img-fluid flex-shrink-0" src="img/testimonial-1.jpg')}}" alt="">
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="{{asset('font/img-fluid flex-shrink-0" src="img/testimonial-2.jpg')}}" alt="">
                        <div class="text-start ms-3">
                            <h5>Client Name</h5>
                            <span class="text-primary">Profession</span>
                        </div>
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="{{asset('font/img-fluid flex-shrink-0" src="img/testimonial-3.jpg')}}" alt="">
                        <div class="text-start ms-3">
                            <h5>Client Name</h5>
                            <span class="text-primary">Profession</span>
                        </div>
    ...
    <script src="{{asset('font/lib/wow/wow.min.js')}}"></script>
    <script src="{{asset('font/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('font/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{asset('font/lib/owlcarousel/owl.carousel.min.js')}}"></script>
